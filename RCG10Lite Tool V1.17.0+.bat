...
:Start
title RCG10Lite Tool (Pre-Realese V1.17.0+ by @rcg10)
cls
...
echo.                     __________________________________________________________
Echo.                    ^|                                                         ^|
Echo.                    ^|   [1] Watch Anime (Aniworld.to)                         ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [2] Watch Series and Movies (s.to)                    ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Return to Start Menu                              ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
if '%wahl%' == '1' Start https://aniworld.to/
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [2] Five Nights at Freddys Help Wanted (non-VR)       ^|
Echo.                    ^|       (Steamunlocked)                                   ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Five Nights at Freddys Help Wanted (Steamunlocked)^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [4] Five Nights at Freddys Security Breach            ^|
Echo.                    ^|       (Steamunlocked)                                   ^|
Echo.                    ^|                                                         ^|
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [Script is Version 1.17.0+ Pre-Realese]               ^|  
Echo.                    ^|                                                         ^|
...
if '%wahl%' == '5' goto:Unlockerdown
if '%wahl%' == '6' goto:KMSdown
if '%wahl%' == '7' goto:GTAC
if '%wahl%' == '8' goto:Start
goto:Tools
