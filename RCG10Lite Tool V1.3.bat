...
:Start
title RCG10Lite Tool (Realese V1.3 by @rcg10)
mode con cols=98 lines=30                     
echo.                     __________________________________________________________
Echo.                    ^|                                                         ^|
Echo.                    ^|   [1] Windows Menu                                      ^|
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [8] Baldis Basics + (Media Fire)                      ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [9] Undertale (Media Fire)                            ^|
Echo.                    ^|                                                         ^|
...
if '%wahl%' == '8' Start https://www.mediafire.com/file/r4y8n479vum8xd2/Baldis_Basics_Plus.zip/file 
if '%wahl%' == '9' Start https://www.mediafire.com/file/1qj7h1lxb0322xl/Undertale.zip/file
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [Script is Version 1.3 [Realese]                      ^|
Echo.                    ^|                                                         ^|
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Return to Programms Section                       ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
if '%wahl%' == '1' goto:OFI
if '%wahl%' == '2' goto:Officeact
if '%wahl%' == '3' goto:softwarep
goto:Office
...
echo.                      __________________________________________________________
Echo.                    ^|                                                         ^|
Echo.                    ^|   [1] Microsoft Office 2007 Enterprise (x64)            ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [100] Return to office menu                           ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
if '%wahl%' == '1' Start https://drive.google.com/uc?id=1JwY6NZQdeRvKYRh2qAkW2q601c6BTJ8y&export=download&goto:of07key
if '%wahl%' == '100' goto:Office
goto:OF07E
