...
if '%wahl%' == '8' goto:Officeact
if '%wahl%' == '9' goto:ReadMe2
if '%wahl%' == '10' goto:ReadMe
if '%wahl%' == '11' goto:CfnSc
if '%wahl%' == '12' goto:Close
...
Echo.                    ^|   [5] Office 2013                                       ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [6] Download Heidoc for Office ISOs                   ^|
Echo.                    ^|                                                         ^|
...
::===========================================================================
SET /p wahl=
if '%wahl%' == '1' goto:OF365
if '%wahl%' == '2' goto:OF2021
if '%wahl%' == '3' goto:OF2019
if '%wahl%' == '4' goto:OF2016
if '%wahl%' == '5' goto:OF2013
if '%wahl%' == '6' goto:Heidocinst
