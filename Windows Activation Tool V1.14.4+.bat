...
::===========================================================================
title Windows Activation Tool (Pre-Realese V1.14.4+ by @rcg10)
:Start
cls
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [Script is Version 1.14.4+ Pre-Realese]               ^|  
Echo.                    ^|                                                         ^|
...
goto:Start
 ...
 :LatestV
echo [1] For older Version [2]  All Versions (GitHub) [3] Newer Version (Website)[4] Return to Menu
SET /p wahl=
if '%wahl%' == '3' goto::WebadorNew
if '%wahl%' == '2' goto:Githubnew
if '%wahl%' == '1' goto:Mediafirenew
if '%wahl%' == '4' goto:Start
goto:Start

:Githubnew
START "" https://github.com/RCG10Lite/Windows-Activation-Tool/releases/new
