...
:Start
title RCG10Lite Tool (Realese V1.0+ by @rcg10)
cls
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [?] Sega Emulation (gets added in newer Versions)     ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Return to Start Menu                              ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
...
if '%wahl%' == 'getsaddedinnewerversions' goto:segaemu
if '%wahl%' == '3' goto:Start
goto:EmuGUI

:segaemu
mode con cols=98 lines=30
echo maybe in the 1.2 Update
echo press any key to return to the Emulation Menu
pause >nul
goto:EmuGUI
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [Script is Version 1.0 [Realese]                      ^|
Echo.                    ^|                                                         ^|
