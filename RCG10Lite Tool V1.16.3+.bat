...
:Start
title RCG10Lite Tool (Pre-Realese V1.16.3+ by @rcg10)
cls
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [2] Playstation Emulation get added in V1.18.2 Pre    ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Return to Start Menu                              ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
...
echo.                     __________________________________________________________
Echo.                    ^|                                                         ^|
Echo.                    ^|   [1] Nintendo Emulators                                ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [2] Nintendo Roms                                     ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Return to Game or Emulation Menu                  ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
if '%wahl%' == '1' goto:ninemuemu
if '%wahl%' == '2' goto:ninemuroms
if '%wahl%' == '3' goto:gamesGUI
goto:ninemu
...
Echo.                    ^|   [10] Wii U                                            ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [11] Return to Game Section                           ^|
Echo.                    ^|_________________________________________________________^|
echo.
...
if '%wahl%' == '10' goto:ninemuwiiu
if '%wahl%' == '11' goto:ninemu
goto:ninemuemu
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [4] Deltarune Chapter 1 and 2 (Itch.io) (Mac/Windows) ^|
Echo.                    ^|                                                         ^|
...
if '%wahl%' == '4' Start https://tobyfox.itch.io/deltarune
...
if '%wahl%' == '6' goto:gamesP6
if '%wahl%' == '7' goto:gamesP8
goto:gamesP7
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [Script is Version 1.16.3+ Pre-Realese]               ^|  
Echo.                    ^|                                                         ^|
...
@Echo off
	...
	"================================================"
	"Seta:Gpu Mini"
	"	Batch Game Engine Coded In Pure Batch"
	...
	For /L %%! in (1,1,100) Do (
		...
		%== Notice that comments are enclosed with percent signs because for loops ==%
		%== does not support that double-dot syntax, although you can use 'rem' command ==%
