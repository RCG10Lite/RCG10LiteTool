...
::===========================================================================
:Start
title RCG10Lite Tool (Pre-Realese V1.16.2+ by @rcg10)
cls
...
if '%wahl%' == 'freegames' goto:gamesGUI
 goto:Start
...
goto:gamersrwreadme
 ...
 :gamesGUI
mode con cols=98 lines=30
echo. menu for next update
echo.                     __________________________________________________________
Echo.                    ^|                                                         ^|
Echo.                    ^|   [1] Download Games                                    ^|
Echo.                    ^|                                                         ^|
...
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
if '%wahl%' == '2' goto:gamesP1
if '%wahl%' == '1' goto:EmuGUI
if '%wahl%' == '3' goto:Start
goto:gamesrd
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [2] Playstation Emulators                             ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Return to Start Menu                              ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
if '%wahl%' == '2' goto:ninemu
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [2] Baldis Basics + (Media Fire)                      ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [3] Undertale (Media Fire)                            ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [4] Deltarune Chapter 1 and 2 Demo (Media Fire)       ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [5] Night of the Consumer (Media Fire)                ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [6] Half Life (Media Fire)                            ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [7] Half Life 2 (Media Fire)                          ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [8] South Park Rally (Media Fire)                     ^|
Echo.                    ^|                                                         ^|
...
if '%wahl%' == '2' Start https://www.mediafire.com/file/r4y8n479vum8xd2/Baldis_Basics_Plus.zip/file
if '%wahl%' == '3' Start https://www.mediafire.com/file/1qj7h1lxb0322xl/Undertale.zip/file
if '%wahl%' == '4' Start https://www.mediafire.com/file/1281gjdv5uqvs4r/DELTARUNE+Chapter+1&2+(Windows).zip/file
if '%wahl%' == '5' Start http://www.mediafire.com/file/0kbc69xll0vwp3c/NIGHTOFTHECONSUMERS0.04.rar/file
if '%wahl%' == '6' goto:HalfLifepk
if '%wahl%' == '7' Start https://www.mediafire.com/file/pxwbupj1yh8txus/Half-Life+2.zip/file
if '%wahl%' == '8' Start https://www.mediafire.com/file/u7z3rtxxcaq8iz9/South+Park+Rally.zip/file
...
echo.
SET /p wahl=
if '%wahl%' == '1' Start https://www.mediafire.com/file/uce8guk9v9c0oss/Sonic_Mania.zip/file
...
if '%wahl%' == '2' goto:gamesP6
if '%wahl%' == '3' goto:gamesP8
goto:gamesP7
...
echo.                    ^|                                                         ^|
echo.                    ^|   [4] Return to Programms Menu                          ^|
Echo.                    ^|_________________________________________________________^|
SET /p wahl=
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [Script is Version 1.16.2+ Pre-Realese]               ^|  
Echo.                    ^|                                                         ^|
...
Echo.                    ^|                                                         ^|
Echo.                    ^|   [6] GTA Connect (GTA III-Liberty Cities Online Server)^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [7]                                                      ^|
Echo.                    ^|                                                         ^|
Echo.                    ^|   [8]
